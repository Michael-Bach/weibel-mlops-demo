...
for the three KF-based pipelines (CA-CFAR, CNN, ConvGRU).
LRT and DP-TBD are evaluated as standalone cell-level detectors (no KF);
their track-level $P_d$ would follow from appending a KF, but that
...
Figure~\ref{fig:snr} shows the full $P_d$--SNR curves for the three
KF-based pipelines.
