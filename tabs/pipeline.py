...
def render():
    ...
    fig_ml.update_layout(
        ...
        yaxis=dict(
            title=dict(text="Train loss", font=dict(color="#e74c3c")),
            side="left", gridcolor=_GRID, zeroline=False,
            tickfont=dict(color="#e74c3c"),
        ),
        yaxis2=dict(
            title=dict(text="Val F1", font=dict(color="#c084fc")),
            overlaying="y", side="right", range=[0, 0.6],
            zeroline=False, tickfont=dict(color="#c084fc"),
